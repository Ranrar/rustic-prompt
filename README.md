...
| **Cross-Platform Rust** | Comprehensive guide for conditional compilation, platform-specific code, imports, and Cargo.toml configurations. | [![Open in VS Code](https://img.shields.io/badge/Open%20in-VS%20Code-007ACC?style=flat-square&logo=visualstudiocode&logoColor=white)](https://vscode.dev/github/Ranrar/rustic-prompt/blob/main/.github/instructions/rust/crossplatform-instructions.md) |
